            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading p-b-15">
                        ...
                        <a href="{{ url('admin/pemilik/create') }}" class="btn btn-complete pull-right btn-rounded btn-xs" type="button" style="width:28px;height:28px;margin-right:4px;margin-top: 3px"><i class="fa fa-plus" style="width:8px;"></i></a>
                        ...
                        <div class="widget-11-2-table">
                            <table class="table table-hover table-t-b-0">
                                ...
                                <tr>
                                    ...
                                    <td width="45%">Nama, <small>Pemilik Toko</small></td>
                                    <td>Alamat</td>
                                    <td>Telepon</td>
                                    <td>Email, <small>Status</small></td>
                                ...
                                <tr id="Pemilik{{ $pemilik->id }}">
                                    <td>{{ $no++ }}.</td>
                                    <td class="font-montserrat fs-12">
                                        <a href="{{ url('admin/pemilik/'.$pemilik->id) }}">{{ $pemilik->nama }}</a>, <small>{{ $pemilik->getToko->nama }}</small>
                                    </td>
                                    <td class="font-montserrat fs-12">
                                        <span class="hint-text small">{{ $pemilik->alamat }}</span><br/>
                                    </td>
                                    <td class="font-montserrat fs-12">
                                        <span class="hint-text small">{{ $pemilik->telepon }}</span><br/>
                                    </td>
                                    <td class="text-left b-r b-dashed b-grey" >
                                        <span class="hint-text small">{{ $pemilik->getUser->email }}, <small>{{ $pemilik->getStatus() }}</small></span><br/>
                                    </td>
                                    <td class="font-montserrat fs-12">
                                        <a onClick="deleteData({{ $pemilik->id }}, 'Pemilik')" class="btn btn-danger b-rad-md btn-xs" type="button" style="height:28px;margin-right:4px;margin-top: -5px;">Hapus</a>
                                        <a href="{{ url('admin/pemilik/'.$pemilik->id.'/edit') }}" class="btn btn-complete b-rad-md btn-xs" type="button" style="height:28px;margin-top: -5px;">Ubah</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
                    ...
                    <div class="panel-footer no-border p-t-0 p-b-0" style="background: #FFF;color: #101010;font-size: 13px;font-weight: 300">
                        {{ $pemiliks->appends($appends)->links()  }}
                    </div>
                </div>
            </div>
        </div>
