            ...
            <div class="col-lg-12">
                    ...
                    <div class="panel-body panel-bordered ">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                {!! $errors->first('kode', '<label class="lb-di error">:message</label>') !!}
                ...
                <div class="panel panel-default">
                    <div class="panel-body sm-p-t-15">
                        {!! Form::open(['url' => 'admin/produk', 'id' => 'formValidate', 'files' => true]) !!}
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <div aria-required="true" class="form-group form-group-default form-group-default {{ $errors->has('kode') ? 'has-error' : ''}}">
                                            ...
                                            {!! Form::text('kode', $kode, ['class' => 'form-control input-md input-re', 'readonly']) !!}
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                        ...
                        <div class="pull-left m-b-20">
                            <div class="checkbox check-success">
                                <input id="checkbox-agree" type="checkbox" required checked> <label for="checkbox-agree"><small>Saya sudah mengecek data sebelum menyimpan</small></label>
                            </div>
                        </div>
