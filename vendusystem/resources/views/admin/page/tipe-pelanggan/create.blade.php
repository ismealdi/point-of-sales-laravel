...
@section('title', 'Tambah Tipe Pelanggan')
@section('description', 'Mohon lengkapi seluruh informasi data')
@section('button')
    <a href="{{ url('/admin/tipe-pelanggan') }}" class="btn btn-info btn-xs no-border">Kembali</a>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body sm-p-t-15">
                        {!! Form::open(['url' => 'admin/tipe-pelanggan', 'id' => 'formValidate', 'files' => true]) !!}
