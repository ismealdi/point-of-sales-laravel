...
@section('button')
    <a href="{{ url('/admin/toko') }}" class="btn btn-info btn-xs no-border">Kembali</a>
@endsection
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div aria-required="true" class="form-group form-group-default required {{ $errors->has('nama') ? 'has-error' : ''}}">
                                    ...
                                    {!! Form::hidden('nama', null, ['class' => 'form-control input-md', 'required' => 'required']) !!}
                                    {!! Form::text('new_nama', $information->nama, ['class' => 'form-control input-md', 'required' => 'required']) !!}
                                </div>
