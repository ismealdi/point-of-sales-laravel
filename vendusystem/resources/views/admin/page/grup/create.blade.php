...
@section('button')
    <a href="{{ url('/admin/grup') }}" class="btn btn-info btn-xs no-border">Kembali</a>
@endsection
            ...
            <div class="col-lg-12">
                    ...
                    <div class="panel-body panel-bordered ">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                {!! $errors->first('jenis', '<label class="lb-di error">:message</label>') !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-body sm-p-t-15">
                        {!! Form::open(['url' => 'admin/grup', 'id' => 'formValidate', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div aria-required="true" class="form-group form-group-default form-group-default-select2  required {{ $errors->has('jenis') ? 'has-error' : ''}}">
                                    {!! Form::label('jenis', "jenis") !!}
                                    {!! Form::select('jenis', $jenis, null, ['class' => 'full-width', 'data-init-plugin' => 'select2']) !!}
                                </div>
                            </div>
                        </div>
                        <br/>
