...
@section('title', 'Informasi Stok Masuk')
            ...
            <div class="col-lg-12">
                <div class="panel panel-default  m-b-50">
                    <div class="panel-heading p-b-15">
                        ...
                        <a onClick="deleteData({{ $information->id }}, 'Stok Masuk')" class="btn btn-danger btn-rounded btn-xs pull-right" type="button" style="height:28px;margin-right:4px;margin-top: 0px;"><i class="fa fa-trash"></i></a>
                    ...
                    <div class="panel-body b-t b-grey no-padding" style="background: #FFF;">
                        <div class="widget-11-2-table">
                            <table class="table table-hover table-t-b-0">
                                ...
                                <tr>
                                    <td class="text-left b-r b-dashed b-grey">Telepon Pemasok</td>
                                    <td class="font-montserrat fs-12" width="85%">{{ $information->getPemasok->telepon }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left b-r b-dashed b-grey">Email Pemasok</td>
                                    <td class="font-montserrat fs-12" width="85%">{{ $information->getPemasok->email }}</td>
                                </tr>
                                <tr>
        ...
        function hapus(){
            ...
            $.ajax({
                ...
                complete: function(data) {
                    window.location.assign("{{url('admin/masuk')}}");
                }
            });
        }
    </script>
