...
@section('title', 'Tambah Tipe Pemasok')
@section('description', 'Mohon lengkapi seluruh informasi data')
@section('button')
    <a href="{{ url('/admin/tipe-pemasok') }}" class="btn btn-info btn-xs no-border">Kembali</a>
@endsection
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body sm-p-t-15">
                        {!! Form::open(['url' => 'admin/tipe-pemasok', 'id' => 'formValidate', 'files' => true]) !!}
