...
@section('button')
    <a href="{{ (Request::get('back') == 'detail') ? url('admin/pelanggan/'.$information->id) : url('admin/pelanggan') }}" class="btn btn-info btn-xs no-border">Kembali</a>
@endsection
                ...
                <div class="panel panel-default">
                    <div class="panel-body sm-p-t-15">
                        ...
                        {!! Form::model($information, [
                          'method' => 'PATCH',
                          'url' => ['/admin/pelanggan', $information->id],
                          'files' => true,
                          'id' => 'formValidate',
                          ]) !!}
